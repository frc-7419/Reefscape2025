...
public class RobotContainer {
    ...
    private final Command alignAndScoreL1Right = new AlignAndScore(drivetrain, elevator, wrist, wristIntakeSubsystem,
    ...
    private final Command alignAndScoreL2Right = new AlignAndScore(drivetrain, elevator, wrist, wristIntakeSubsystem,
    ...
    private final Command alignAndScoreL3Right = new AlignAndScore(drivetrain, elevator, wrist, wristIntakeSubsystem,
    ...
    private final Command alignAndScoreL4Right = new AlignAndScore(drivetrain, elevator, wrist, wristIntakeSubsystem,
