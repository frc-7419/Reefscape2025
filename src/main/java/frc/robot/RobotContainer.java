...
public class RobotContainer {
        ...
        private void configureBindings() {
                ...
                operator
                                ...
                                .whileTrue(
                                                Commands.defer(
                                                                () -> new ScoringSetpoints(elevator, wrist,
                                                                                ScoringSetpoint.HOME),
                                                                scoringDependencies));
                ...
                operator
                                ...
                                .whileTrue(
                                                Commands.defer(
                                                                () -> {
                                                                        if (coral)
                                                                                return new ScoringSetpoints(elevator,
                                                                                                wrist,
                                                                                                ScoringSetpoint.L2);
                                                                        else
                                                                                return new ScoringSetpoints(elevator,
