...
public class RobotContainer {
    ...
    private final Command alignAndScoreL2Left = new SequentialCommandGroup(
    ...
    private final Command alignAndScoreL2Right = new SequentialCommandGroup(
            // first try to score at L2
            new AlignAndScore(
                    drivetrain,
                    elevator,
    ...
    private final Command scoreL4 = new ScoreWithoutAlign(drivetrain, elevator, wrist, wristIntakeSubsystem,
            ScoringSetpoint.L4);
    private final Command scoreL3 = new ScoreWithoutAlign(drivetrain, elevator, wrist, wristIntakeSubsystem,
            ScoringSetpoint.L3);
    private final Command scoreL2 = new ScoreWithoutAlign(drivetrain, elevator, wrist, wristIntakeSubsystem,
            ScoringSetpoint.L2);
