...
/**
 * A wrapper that integrates WPILib's Alert with the Elastic dashboard notification system. It sends
 * notifications when the alert transitions from off to on.
 */
public class CombinedAlert {
   ...
   * @param displayTimeMs The time in milliseconds the notification is displayed (0 = no
   *     auto-dismiss).
  ...
  public CombinedAlert(
    ...
    this.notification =
        new ElasticNotification(
            mapSeverityToElasticLevel(severity), title, description, displayTimeMs, width, height);
  }

  // Convenience Constructors (mirroring ElasticNotification) //

  /**
   * Creates a CombinedAlert with a specified severity, title, and description, using default
   * display time (3000 ms), default width (350), and automatic height (-1).
   *
   * @param severity The severity level of this alert.
   * @param title The title text of the notification.
   * @param description The description text of the notification.
  ...
  /**
   * Creates a CombinedAlert with a specified severity, title, and description, and a custom display
   * time. Uses default width (350) and automatic height (-1).
   *
   * @param severity The severity level of this alert.
   * @param title The title text of the notification.
   * @param description The description text of the notification.
  ...
  /**
   * Creates a CombinedAlert with a specified severity, title, and description, and custom
   * width/height. Uses default display time (3000 ms).
   *
   * @param severity The severity level of this alert.
   * @param title The title text of the notification.
   * @param description The description text of the notification.
   ...
   */
  public CombinedAlert(
      Severity severity, String title, String description, double width, double height) {
   ...
   *
   * @param active If true, displays the alert and sends a notification (if just transitioned to
   *     true). If false, hides the alert.
   */
