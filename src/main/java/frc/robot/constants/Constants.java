...
public class Constants {
  ...
  public static class ElevatorConstants {
    ...
    static {
      ...
      kElevatorSlot0Configs.kV = 0.26; // output per unit of target velocity (output/rps)
      kElevatorSlot0Configs.kA = 0.01; // output per unit of target acceleration (output/(rps/s))
      kElevatorSlot0Configs.kP = 0.59; // output per unit of error in position (output)
