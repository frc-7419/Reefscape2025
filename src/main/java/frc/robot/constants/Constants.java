...
public class Constants {
  ...
  public static class ScoringConstants {
    ...
    public static final Translation2d leftReefOffset = new Translation2d(0.444, 0.1651); // should probally be robot
    // bumper
    // offset to be flush and then the left
    public static final Translation2d rightReefOffset = new Translation2d(0.444, -0.1651); // should probally be robot
  ...
  public static class VisionConstants {
    ...
    public static final Matrix<N3, N1> kSingleTagStdDevs = VecBuilder.fill(1, 1, Degrees.of(5).in(Radians));
    public static final Matrix<N3, N1> kMultiTagStdDevs = VecBuilder.fill(0.1, 0.1, Degrees.of(1).in(Radians));
  ...
  public static class ElevatorConstants {
    ...
    static {
      ...
      kElevatorSlot0Configs.kP = 3.5; // output per unit of error in position (output)
    ...
    static {
      ...
      kMotionMagicConfig.MotionMagicAcceleration = 50;
    }
